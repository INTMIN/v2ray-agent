...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/INTMIN/v2ray-agent/mini/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
...
### 安装Docker版
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/INTMIN/v2ray-agent/mini/shell/docker_reality.sh" && chmod 700 /root/docker_reality.sh && /root/docker_reality.sh
```
