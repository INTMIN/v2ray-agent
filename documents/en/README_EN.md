...
```
bash wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/INTMIN/v2ray-agent/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
...
*   **Feedback:** [Submit an issue](https://github.com/INTMIN/v2ray-agent/issues)
